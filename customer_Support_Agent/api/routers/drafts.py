...
#we wamt to prevent initialzation of services again and again therefore we are using lru_cache and calling it from dependencies
...
from customer_Support_Agent.schemas.api import DraftUpdateRequest,DraftResponse
    ...
    if payload.status == "accepted":
        ...
        if relation:
            ...
            try:
                ...
                print(f"Error saving accepted resolution: {e}")  # Log the error or handle it as needed
                pass
