...
from customer_Support_Agent.repositories.sqlite import CustomerRepository  #since  we havealready defined it in sqlite __init__.py file
...
def _load_band(open_count:int)->str:  #count how many tickets are open for particular customer
    if open_count <= 1 :
        return "light"
    elif open_count <= 3:
        return "moderate"
